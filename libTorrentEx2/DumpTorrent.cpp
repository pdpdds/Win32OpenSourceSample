// DumpTorrent.cpp : 콘솔 응용 프로그램에 대한 진입점을 정의합니다.
//
...
#pragma comment(lib, "boost_filesystem-vc120-mt-gd-1_55.lib")
...
int main(int argc, char* argv[])
{
	...
	if (argc != 2)
	{
		std::cerr << "usage: libTorrentDump torrent-file\n";
		return 1;
	}
	...
	try
	{
		...
		std::cout << "\n\n----- raw info -----\n\n";
		std::cout << e.string_cstr() << std::endl;
