...
namespace widgets
{
    ...
    void init()
    {
		...
		font = new gcn::ImageFont("font.bmp", " abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789.,!?-+/():;%&''*#=[]\"");
		...
		ListBoxScrollArea->setWidth(100);
		ListBoxScrollArea->setHeight(40);
